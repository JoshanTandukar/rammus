...
class UsersListDialog extends StatefulWidget
{
  ...
  final Function(Users) onInviteUser;
  ...
  @override
  UsersListDialogState createState() => UsersListDialogState();
}

class UsersListDialogState extends State<UsersListDialog>
{
                ...
                itemBuilder: (BuildContext context, int index)
                {
                  return Container(
                    ...
                    child: TextButton(
                      ...
                      onPressed:()
                      {
                        widget.onInviteUser(widget.listUsers[index]);
                      },
                      child: Container(
                        alignment: Alignment.centerLeft,
                        margin: EdgeInsets.fromLTRB(Dimens.space0.w, Dimens.space0.h, Dimens.space0.w, Dimens.space0.h),
                        padding: EdgeInsets.fromLTRB(Dimens.space0.w, Dimens.space0.h, Dimens.space0.w, Dimens.space0.h),
                        child: Text(
                          widget.listUsers[index].name!=null && widget.listUsers[index].name!.isNotEmpty? widget.listUsers[index].name!:"Not Available",
                          style: Theme.of(context).textTheme.bodyText1!.copyWith(
                            color: Color(0xff5E6272),
